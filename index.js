...
/////////////////
const BotName = 'V14n_Bot'; 
const instagram = 'https://instagram.com/avn_official.03'; 
const whatsapp = 'wa.me/17016607496'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@avn_official.03`)
})
